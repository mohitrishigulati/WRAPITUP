...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://api.stripe.com https://*.stripe.com https://api.razorpay.com https://*.razorpay.com",
      "frame-src https://js.stripe.com https://hooks.stripe.com https://api.razorpay.com https://*.razorpay.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
    ].join("; "),
